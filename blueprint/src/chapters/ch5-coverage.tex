...
\lean{ConwayO7.Cube, ConwayO7.Cube.eval}
\leanfile{ConwayO7/Semantics.lean}\leanok
...
ConwayO7.Dimacs.serializeCubes}
\leanfile{ConwayO7/Dimacs.lean}\leanok
\uses{def:cnf-formula, def:cnf-cube}
\end{definition}
...
\lean{ConwayO7.cubeOfSigns, ConwayO7.PrefixFree}
\leanfile{ConwayO7/Coverage.lean}\leanok
\uses{def:cnf-cube}
\end{definition}
...
\lean{ConwayO7.cubeOfSigns_eval_iff}
\leanfile{ConwayO7/Coverage.lean}\leanok
...
ConwayO7.prefixFree_branchTails}
\leanfile{ConwayO7/Coverage.lean}\leanok
...
\lean{ConwayO7.covers_of_prefixFree_kraft}
\leanfile{ConwayO7/Coverage.lean}\leanok
...
member of $S$.
\lean{ConwayO7.cube_cover_of_signs}
\leanfile{ConwayO7/Coverage.lean}\leanok
\uses{def:prefix, def:cnf-valuation}
\end{lemma}
\begin{proof}[Proof sketch]
...
ConwayO7.lexLe_antisymm}
\leanfile{ConwayO7/CoverageCheck.lean}\leanok
\end{definition}
...
\lean{ConwayO7.prefix_of_lexLe_of_lexLe, ConwayO7.lexLe_of_prefix}
\leanfile{ConwayO7/CoverageCheck.lean}\leanok
\uses{def:cov-lex}
\end{lemma}
\begin{proof}[Proof sketch]
...
\lean{ConwayO7.pairwise_of_sorted_adjacent}
\leanfile{ConwayO7/CoverageCheck.lean}\leanok
...
\lean{ConwayO7.cover_of_checkCover}
\leanfile{ConwayO7/CoverageCheck.lean}\leanok
...
\lean{ConwayO7.unsat_of_prefix_cover}
\leanfile{ConwayO7/CoverageCheck.lean}\leanok
...
\lean{ConwayO7.unsat_of_checked_cover}
\leanfile{ConwayO7/CoverageCheck.lean}\leanok
...
embedded data.
\lean{ConwayO7.o7Tiling_checkCover}
\leanfile{ConwayO7/Data/FullTiling.lean}\leanok
