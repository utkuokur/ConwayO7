...
ConwayO7.orbitOf_sigma0}\leanok
\uses{def:sigma0}
\end{definition}
...
ConwayO7.orbitRep_reaches}\leanok
...
\lean{ConwayO7.graphOfOrbits}\leanok
...
\lean{ConwayO7.graphOfOrbits_invariant}\leanok
...
\lean{ConwayO7.orbitFunOf, ConwayO7.graphOfOrbits_orbitFunOf}\leanok
...
\lean{ConwayO7.Encoder.St, ConwayO7.Encoder.SatAll, ConwayO7.Encoder.WF}\leanok
\end{definition}
...
ConwayO7.Encoder.litSat_evarI}\leanok
...
\lean{ConwayO7.Encoder.mkO7St, ConwayO7.Encoder.mkO7Cnf}\leanok
...
\lean{ConwayO7.Encoder.mkO7_no_zero}\leanok
\uses{def:phi}
\end{lemma}
...
ConwayO7.Encoder.sat_mkO7Cnf_of_satAll}\leanok
...
\lean{ConwayO7.mkO7Cnf_eq, ConwayO7.o7cnf_bytes}\leanok
\uses{def:phi}
\end{fact}
...
protected variables.
\lean{ConwayO7.Encoder.GTrip}\leanok
\uses{def:enc-state}
\end{definition}
...
\lean{ConwayO7.Encoder.GTrip.comp, ConwayO7.Encoder.GTrip.foldl_inv}\leanok
\uses{def:enc-gtrip}
\end{lemma}
...
\lean{ConwayO7.Encoder.DegInv}\leanok
\uses{def:enc-evar}
\end{definition}
...
\lean{ConwayO7.Encoder.cnCountR, ConwayO7.Encoder.CnInv}\leanok
...
Lemma~\ref{lem:sym1}.
\lean{ConwayO7.Encoder.Sym1Holds}\leanok
...
\lean{ConwayO7.Encoder.PreLexInv}\leanok
...
inputs.
\lean{ConwayO7.TotSpec.UnaryOut, ConwayO7.MtoSpec.UnaryOf}\leanok
\uses{def:enc-state}
\end{definition}
...
variables $\leq T$.
\lean{ConwayO7.SeqSpec.spec_sat}\leanok
\uses{def:enc-state}
\end{proposition}
...
\lean{ConwayO7.TotSpec.toUA_sat}\leanok
\uses{def:enc-unary}
\end{lemma}
...
\lean{ConwayO7.TotSpec.toTO_sat}\leanok
...
\lean{ConwayO7.MtoSpec.mtoMTO_sat}\leanok
...
\lean{ConwayO7.MtoSpec.mtoAtMost_sat}\leanok
\uses{prop:enc-mto}
\end{proposition}
...
\lean{ConwayO7.Encoder.encEqualsDeg_sat}\leanok
...
\lean{ConwayO7.Encoder.degreeStep_trip, ConwayO7.Encoder.deg_section_trip}\leanok
...
\lean{ConwayO7.Encoder.prodFold_sat}\leanok
...
\lean{ConwayO7.Encoder.specSeqEquals_sat}\leanok
...
emission triple.
\lean{ConwayO7.Encoder.specCnStep_trip, ConwayO7.Encoder.cn_section_trip}\leanok
...
\lean{ConwayO7.Encoder.sym1_section_trip}\leanok
...
\lean{ConwayO7.Encoder.preLexSpec_trip, ConwayO7.Encoder.preLex_sat}\leanok
...
\lean{ConwayO7.Encoder.degInv_of_srg}\leanok
...
\lean{ConwayO7.Encoder.cnInv_of_srg}\leanok
...
\lean{ConwayO7.Encoder.preLexInv_of_srg}\leanok
